...
struct device *pdev;//specific to one device
...
struct kfifo kfifo;//specific to one device

dev_t pdevid;

struct cdev cdev;//specific to one device
...
printk("Pseudo driver kfifo sample ...welcome \n");
